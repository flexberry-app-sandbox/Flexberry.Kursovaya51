...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya5 директор отдела по работе с клиентами l');

test('testing i-i-s-kursovaya5-директор-отдела-по-работе-с-клиентами-l', function(assert) {
