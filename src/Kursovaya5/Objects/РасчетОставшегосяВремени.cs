...
namespace IIS.Kursovaya5
{
    ...
    public class РасчетОставшегосяВремени : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya5.РасторжениеДоговора fEmpty;
        ...
        [PropertyStorage(new string[] {
                "РасторжениеДоговора"})]
        [NotNull()]
        public virtual IIS.Kursovaya5.РасторжениеДоговора Empty
        {
            get
            {
                IIS.Kursovaya5.РасторжениеДоговора result = this.fEmpty;
                return result;
            }
            set
            {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kursovaya5.ОказаниеКонсультаций.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОставшегосяВремениE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОставшегосяВремениE", typeof(IIS.Kursovaya5.РасчетОставшегосяВремени));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРасчетОставшегосяВремени : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kursovaya5.DetailArrayOfРасчетОставшегосяВремени members)

        // *** End programmer edit section *** (IIS.Kursovaya5.DetailArrayOfРасчетОставшегосяВремени members)
        ...
        /// </summary>
        public DetailArrayOfРасчетОставшегосяВремени(IIS.Kursovaya5.ОказаниеКонсультаций fОказаниеКонсультаций) : 
                base(typeof(РасчетОставшегосяВремени), ((ICSSoft.STORMNET.DataObject)(fОказаниеКонсультаций)))
        {
        }
        
        public IIS.Kursovaya5.РасчетОставшегосяВремени this[int index]
        {
            get
            {
                return ((IIS.Kursovaya5.РасчетОставшегосяВремени)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kursovaya5.РасчетОставшегосяВремени dataobject)
        {
